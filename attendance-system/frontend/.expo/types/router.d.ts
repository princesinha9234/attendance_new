...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(owner/)/analytics` | `/analytics` | `/(owner/)/dashboard` | `/dashboard` | `/(owner/)/institutions` | `/institutions` | `/(owner/)/profile` | `/profile` | `/(owner/)/users` | `/users` | `/(student/)/attendance-history` | `/attendance-history` | `/(student/)/dashboard` | `/(student/)/face-verify` | `/face-verify` | `/(student/)/profile` | `/(student/)/scan-qr` | `/scan-qr` | `/(teacher/)/class-stats` | `/class-stats` | `/(teacher/)/create-session` | `/create-session` | `/(teacher/)/dashboard` | `/(teacher/)/manual-attendance` | `/manual-attendance` | `/(teacher/)/profile` | `/(teacher/)/qr-display` | `/qr-display` | `/(teacher/)/session-detail` | `/session-detail` | `/face-enroll` | `/login` | `/register`;
  // prettier-ignore
